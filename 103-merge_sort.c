...
/**
 * merge_compare - Compares and merges two subarrays
 * @array: The integer array to sort
 * @start: The start index of the left subarray
 * @stop: The stop index of the right subarray
...
/**
 * merge_sort_top_down - Sorts the array using top-down merge sort recursively
 * @array: The integer array to sort
 * @start: The start index of the subarray
 * @stop: The stop index of the subarray
 * @new: The output array
 *
 * Return: void
 */
