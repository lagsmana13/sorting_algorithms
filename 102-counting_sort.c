...
/**
 * integer_count - Counts the number of occurrences of an integer in an array
 *
 * @array: Array to search for occurrences
 * @size: Size of the array
 * @range: Number to check for occurrences
 *
...
/**
 * counting_sort - Performs counting sort algorithm on an array
 *
